...
let inputs = [
    ...
    { name: "animation-text-color", title: "Цвет текста при анимации в формате hex, hsl(a) или rgb(a), если нужно чтобы он менялся при наведении (возможено для всех эффектов, кроме 2го) ", place: "" },
    { name: "gradient-background-begin", title: "Начальный цвет градиента для фона кнопки в формате hex, hsl(a) или rgb(a). Обязательное поле для создания градиента.(Наличие градиента обязательно для работы эффектов 9-12, и возможно для эффектов 3, 19-22)", place: "" },
    { name: "gradient-background-middle", title: "Серединный цвет градиента для фона кнопки в формате hex, hsl(a) или rgb(a). Можно добавить, если нужен трехцветный градиент", place: "" },
    { name: "gradient-background-end", title: "Конечный цвет градиента для фона кнопки в формате hex, hsl(a) или rgb(a). Обязательное поле для создания градиента.", place: "" },
]
